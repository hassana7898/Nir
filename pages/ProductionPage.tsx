...
const ProductionPage: React.FC = () => {
    ...
    const handleSaveFormula = async () => {
        ...
        if (editingFormula) {
            ...
            await dataService.updateFormula(updatedFormula);
            ...
            await dataService.saveFormula({ finishedGoodId: selectedFinishedGood, items: formulaItems });
    ...
    const handleDeleteFormula = (id: string) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                await dataService.deleteFormula(id);
                setFormulas(dataService.getFormulas());
    ...
    const handleRecordProduction = async () => {
        ...
        await dataService.addProductionRecord({
